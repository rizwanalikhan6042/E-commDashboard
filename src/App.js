    ...
    <div className="App">
      <BrowserRouter basename="/">
        ...
        <Routes>
          ...
          {/* The components which we want to make private will be under this private component route The meaning of making component private means when user logged in only then this components will appear and user can access otherwise not*/}
